/* ============================================================
   ...
   ============================================================ */
const state = {
    products: [],              // parsed products from the uploaded file
...
/* ============================================================
   FILE UPLOAD & PARSING
   ============================================================ */
$('txtUpload').addEventListener('change', function (e) {
...
const virtualList = (function createStandardList() {
    ...
    function refresh() {
        ...
        if (!itemsToRender || itemsToRender.length === 0) {
            if (state.products.length === 0) {
                container.innerHTML = '<div class="hint">Upload a text file to load products.</div>';
            } else {
    ...
    function createRowSkeleton(product) {
        ...
        row.innerHTML = `
            <div class="row-head">
                <div class="row-title"><b class="rt-id"></b><span class="rt-name"></span><span class="cat-tag rt-cat"></span></div>
    ...
    function paintRow(row, product) {
        row.querySelector('.rt-id').textContent = product.id;
        row.querySelector('.rt-name').textContent = ` ${product.brand} ${product.sku} `;
